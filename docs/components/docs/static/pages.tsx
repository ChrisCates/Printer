...
export default function Pages() {
  ...
  return (
    <>
      ...
      <p>
        You can run the following to create a standard new page. This generates
        a Printer styled page. The following uses an example path of
        &quot;test&quot;. If you specify [url] parameters. Printer will
        automatically inject the query parameters for you. Review the following
        examples.
      </p>
