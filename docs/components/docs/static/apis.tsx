...
export default function Pages() {
    ...
    return (
        <>
            ...
            <p>
                You can run the following to create a standard new API route. This generates a Printer styled API route. The following uses an example path of &quot;test&quot;.
                API routes will automatically inject iron-session into the generated code.
            </p>
